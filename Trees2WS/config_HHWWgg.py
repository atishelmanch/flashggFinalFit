...
trees2wsCfg = {
  ...
  'cats':["HHWWggTag_0","HHWWggTag_1","HHWWggTag_2"],

  # Analysis type. Ex: HHWWgg_NLO_1 --> HHWWgg analysis, Semi-Leptonic final state, NLO sample, cHHH1
  'analysis' : 'HHWWgg_SL_NLO_1',

  ##-- HHWWgg MC
  ##-- NLO 
  ## GluGluToHHTo2G2Qlnu_node_cHHH1_13TeV_HHWWggTag_0

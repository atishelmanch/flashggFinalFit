...
signalScriptCfg = {
  ...
  'ext':'SL_HHWWyyDNN_binary_EFT_noHgg_noNegWeights_BalanceYields_allBkgs_LOSignals_noPtOverM_withKinWeight_weightSel_GluGluToHHTo2G2Qlnu_%s_single_Higgs'%_year,
